...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _animateText = __webpack_require__(1);

	var _animateText2 = _interopRequireDefault(_animateText);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	window.onload = function () {

		var songLetter = document.querySelectorAll('.song__letter');
		var song = document.querySelector('.song');

		song.onmouseleave = function () {
			return _animateText2.default.textAnimate(songLetter);
		};
		song.onmouseenter = function () {
			return _animateText2.default.textNormalize(songLetter);
		};
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _randomNumber = __webpack_require__(4);
	...
	var textAnimate = function textAnimate() {
		var elementsArr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
		...
		for (var i = 0, iter = elementsArr.length; i <= iter; i++) {

			arrX.push(_randomNumber2.default.random(-200, 200));
			arrY.push(_randomNumber2.default.random(-100, 100));
			arrScale.push(_randomNumber2.default.random(1, 5));
			arrRotation.push(_randomNumber2.default.random(-360, 360) + 'deg');
		}
	...
	var textNormalize = function textNormalize(elementsArr) {
			...
			this.check = function (init) {
				...
				if (missing === 0 && func) {
					...
					if (global) {
						...
						if (!hasModule && "function" === "function" && __webpack_require__(3)) {
							//AMD
